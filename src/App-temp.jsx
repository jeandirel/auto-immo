...
function DetailAnnonce() {
    ...
    if (!annonce) return <div className="container mx-auto px-4 py-12">Annonce non trouvée</div>

    const shareUrl = window.location.href

    return (
        <div className="container mx-auto px-4 py-12">
            <button onClick={() => window.history.back()} className="text-primary mb-6">← Retour</button>
                    ...
                    >
                        ...
                        <div className="pointer-events-none">
                            ...
                            <p className="text-xs text-gray-400 mt-4">
                                JPG, PNG, GIF • Jusqu'à 10MB • Plusieurs fichiers acceptés
                            </p>
                        </div>
                    </div>
